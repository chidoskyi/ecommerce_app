...
export default function TodaysDealsSection() {
  ...
  if (error) {
    ...
    if (todaysDeals.length === 0) return <div className="text-center py-8">No deals available today</div>;

    return (
        <Container className="mx-auto px-4 py-8 shadow-md rounded-[8px] relative mb-12 bg-white"> 
            <div className="flex items-center justify-between mb-8 border-b border-gray-300 pb-5">
                <h2 className="md:text-3xl text-xl font-bold text-gray-700">Today&apos;s Deals</h2>
                <button className="text-orange-500 hover:text-orange-600 font-medium cursor-pointer" onClick={handleSeeMore}>See More →</button>
            </div>
